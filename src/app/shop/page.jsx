...
import { Star, Heart, ShoppingCart, Eye, Filter, SortAsc, Zap } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-5xl font-black text-white">
              Shop All <span className="bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">Products</span>
            </h1>
            <Zap className="w-8 h-8 text-yellow-400 animate-pulse" />
          </div>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Explore our entire collection of premium products across all categories
          </p>
        </div>
      </section>
